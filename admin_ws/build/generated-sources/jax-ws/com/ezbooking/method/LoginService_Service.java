 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://method.ezbooking.com/", wsdlLocation = "http://localhost:8080/Server_WS/LoginService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://method.ezbooking.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Server_WS/LoginService?wsdl");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://method.ezbooking.com/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://method.ezbooking.com/", "LoginServicePort"), LoginService.class, features);
    }
